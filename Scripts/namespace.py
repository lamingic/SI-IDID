...
class Name(object):
    def __init__(self):
        ...
        self.Prefixs = {'DID': {0: '', 1: 'extn_', 2: 'gene_', 3: 'solv_', 4: 'extp_', 6: 'merg_'}, \
                        'IDID': {0: '', 1: 'extn_', 2: 'gene_', 3: 'solvd_', 4: 'expa_', 5: 'solv_', 6: 'extp_',
                                 7: 'merg_'}}
        ...
        for key in range(1, len(self.Step.keys()) + 1):
            if not self.Step.get(key).__contains__('DID'):
                ...
                index = index + 1
        self.MODPrefix = {'DID': dict.fromkeys(self.Steps.get('DID').values(), ''),
        ...
        self.Solver_types = {"DID": {'solving network': '', 'extending policy trees': ''},
                             "IDID": {'solving network': '', 'extending policy trees': ''}}
        self.Solver = {1: 'Exact', 2: 'GA', 3: 'PGA', 4: 'GGA', 5: 'MGA', 6: 'MPGA', 7: 'MGGA', 8: 'DE'}
        self.Extension = {1: '', 2: 'GA', 3: 'PM', 4: 'ACO', 5: 'PSOC', 6: 'GC', 7: 'CM'}
        self.Fitness_method = {1: 'distance', 2: 'diversity', 3: 'reward'}
        self.Group_criterion_method = {1: 'distance', 2: 'diversity', 3: 'reward'}
        self.Emigrate_method = {1: 'Random', 2: 'Random-bound', 3: 'Sigmoid-bound', 4: 'Sigmoid-cutoff',
                                5: 'Sigmoid-group-cutoff'}
        ...
        self.Result = {'policy_tree', 'policy_dict', 'reward', 'policy_path_weight', 'prior_belief', 'Plot', 'Fitness'}
        ...
        self.pm_parameters = ["fitness_method", "pop_size", "tournament_size", "generation_size", "learning_rate1",
                              "learning_rate2", "weight_rate", "pelite_mode"]
        self.cm_parameters = ["fitness_method", "pop_size", "tournament_size", "generation_size", "learning_rate1",
                              "learning_rate2", "weight_rate", "pelite_mode"]
        self.aco_parameters = ["fitness_method", "pop_size", "tournament_size", "generation_size", "rho_rate",
                               "trans_rate", "pelite_mode"]
        ...
        self.GUI_Frames = ['Domain', 'Models', 'Simulation', 'Play', 'Meessage', 'Figure', 'Plot', 'Alg', 'Table',
                           'PolicyTree']
        cb = ['Domain', 'Play']
        ...
        self.messeage_clues = ['coverage', 'plot_coverage', 'analysis', 'Plot', 'Alg', 'table', 'Diversity',
                               'PolicyTree']
...
class DomainParameters(object):
    def __init__(self):
        ...
        self.parameters_setting = {self.parameters[0]: list(self.pnames.Domain.values()), \
                                   self.parameters[1]: 8, self.parameters[2]: 1, \
                                   self.parameters[3]: 500, self.parameters[4]: 3, self.parameters[5]: 10000}
        self.Name = ''
...
class GA_ps(object):
    def __init__(self):
        ...
        self.parameters_setting[self.parameters[1]] = 8
        self.parameters_setting[self.parameters[2]] = 50
        self.parameters_setting[self.parameters[3]] = 4
        ...
        self.parameters_setting[self.parameters[9]] = False
...
class PM_ps(object):
    def __init__(self):
        self.pnames = Name()
        self.parameters = self.pnames.pm_parameters
        self.values = dict.fromkeys(self.parameters, '')
        self.parameters_type = dict()
        self.update_dict()
        ...
        self.parameters_setting[self.parameters[0]] = list(self.pnames.Fitness_method.values())
        self.parameters_setting[self.parameters[1]] = 8
        self.parameters_setting[self.parameters[2]] = 4
        self.parameters_setting[self.parameters[3]] = 50
        self.parameters_setting[self.parameters[4]] = 0.4
        self.parameters_setting[self.parameters[5]] = 0.4
        self.parameters_setting[self.parameters[6]] = 0.8
        self.parameters_setting[self.parameters[7]] = True
...
class ACO_ps(object):
    def __init__(self):
        self.pnames = Name()
        self.parameters = self.pnames.aco_parameters
        self.values = dict.fromkeys(self.parameters, '')
        self.parameters_type = dict()
        self.update_dict()
        ...
        self.parameters_setting[self.parameters[2]] = 4
        self.parameters_setting[self.parameters[3]] = 50
        self.parameters_setting[self.parameters[4]] = 0.9
        self.parameters_setting[self.parameters[5]] = 0.3
        self.parameters_setting[self.parameters[6]] = True
...
class CM_ps(object):
    def __init__(self):
        self.pnames = Name()
        self.parameters = self.pnames.cm_parameters
        self.values = dict.fromkeys(self.parameters, '')
        self.parameters_type = dict()
        self.update_dict()
        ...
        self.parameters_setting[self.parameters[1]] = 8
        self.parameters_setting[self.parameters[2]] = 4
        self.parameters_setting[self.parameters[3]] = 100
        self.parameters_setting[self.parameters[4]] = 0.5
        self.parameters_setting[self.parameters[5]] = 0.4
        self.parameters_setting[self.parameters[6]] = 0.8
        self.parameters_setting[self.parameters[7]] = True

...
###########################################################
class Node(object):
    def __init__(self, id=None, label=None, level=None, parents=None, arcs_from_parents=None, children=None,
                 arcs_to_children=None):
        self.id = id
        self.label = ' '
    ...
    # copy
    def copy(self):
        node = Node(self.id, self.label, self.level, self.parents, self.arcs_from_parents, self.children,
                    self.arcs_to_children)
        return node
